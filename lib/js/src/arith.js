...
function do_divmod(l, a, b) {
  ...
  var dr = BigInteger.divmod(converted_args[0], {
        NAME: "BigInt",
        VAL: converted_args[1]
      });
  return {
          TAG: /* RunOk */2,
          _0: {
            ...
            _0: [
              l,
              {
                ...
                _0: [
                  l,
                  BigInteger.toString(dr.quotient, undefined, undefined)
                ]
              },
              {
                TAG: /* Integer */2,
                _0: [
                  l,
                  BigInteger.toString(dr.remainder, undefined, undefined)
                ]
              }
            ]
          }
