...
function make_let_bindings(any) {
  switch (any.TAG | 0) {
    case /* Nil */0 :
        return {
                TAG: /* CompileOk */0,
    ...
    case /* Cons */1 :
        ...
        if (match$1.TAG === /* Cons */1) {
          ...
          if (match$3.TAG === /* Atom */4) {
            var match$4 = match$2[2];
            if (match$4.TAG === /* Cons */1) {
              var match$5 = match$4._0;
              if (match$5[2].TAG === /* Nil */0) {
                var tl = match[2];
                var match$6 = match$3._0;
                var name = match$6[1];
                var l = match$6[0];
                return Comptypes.compBind((function (body) {
                              return Comptypes.compMap((function (rest) {
                                            return {
                                                    hd: /* Binding */{
                                                      _0: [
                                                        l,
  ...
  return {
          ...
          _1: "Bad binding tail " + Sexp.to_string(any)
        };
}
    ...
    case /* Atom */4 :
        switch (head._0[1]) {
          case "let" :
              ...
              var body = match$4[1];
              return Comptypes.compBind((function (bindings) {
                            return Comptypes.compMap((function (body) {
                                          return {
                                                  TAG: /* Let */0,
                                                  _0: [
                                                    l,
          ...
          case "qq" :
              ...
              if (match$5.TAG === /* Cons */1) {
                ...
                if (match$6[2].TAG === /* Nil */0) {
                  return qq_to_expression(match$6[1]);
                }
...
exports.make_let_bindings = make_let_bindings;
