...
function generate_expr_code(opts, compiler, _expr) {
  while(true) {
    var expr = _expr;
    switch (expr.TAG | 0) {
      case /* Let */0 :
      ...
      case /* Value */2 :
          ...
          if (v === "@") {
            ...
            return Comptypes.compMap((function(l$1){
                      return function (f) {
                        return /* Code */{
                                _0: l$1,
                                _1: f
                      ...
                      }(l$1)), create_name_lookup(compiler, l$1, v));
          }
      case /* Call */3 :
          var match$1 = expr._0;
          ...
          if (match$3.TAG === /* Value */2) {
            ...
            if (match$4.TAG === /* Atom */4) {
              ...
              return Comptypes.compBind((function(l$2,tl){
                        ...
                        }(l$2,tl)), get_callable(opts, compiler, l$2, {
                              TAG: /* Atom */4,
                              _0: [
                                match$5[0],
                                match$5[1]
...
function generate_let_args(l, param) {
  if (!param) {
    return /* [] */0;
  }
  ...
  return {
          hd: match[2],
          tl: generate_let_args(match[0], param.tl)
        };
}
...
function process_helper_let_bindings(compiler, _param) {
  while(true) {
    var param = _param;
    if (!param) {
      return /* [] */0;
    ...
    switch (any.TAG | 0) {
      ...
      case /* Defun */2 :
          var match = any._0;
          var args = match[3];
          var match$1 = hoist_body_let_binding(compiler, match[4]);
          var new_args = List.concat({
                hd: match$1[0],
                tl: {
                  hd: param.tl,
                  tl: /* [] */0
          ...
          var subcompiler_prims = compiler.prims;
          var subcompiler_constants = compiler.constants;
          var subcompiler_macros = compiler.macros;
          var subcompiler_defuns = compiler.defuns;
          var subcompiler_parentfns = compiler.parentfns;
          var subcompiler_env = combine_defun_env(compiler.env, args);
          var subcompiler_to_process = compiler.to_process;
          var subcompiler_final_expr = compiler.final_expr;
          var subcompiler_final_code = compiler.final_code;
          var subcompiler = {
            prims: subcompiler_prims,
            constants: subcompiler_constants,
            macros: subcompiler_macros,
            defuns: subcompiler_defuns,
            parentfns: subcompiler_parentfns,
            env: subcompiler_env,
            to_process: subcompiler_to_process,
            final_expr: subcompiler_final_expr,
            final_code: subcompiler_final_code
          };
          return {
                  hd: {
                    TAG: /* Defun */2,
                  ...
                  tl: process_helper_let_bindings(subcompiler, new_args)
                };
...
function hoist_body_let_binding(compiler, any) {
  if (any.TAG !== /* Let */0) {
    return [
            /* [] */0,
            any
  ...
  var l = match[0];
  var defun_name = Gensym.gensym("letbinding");
  var generated_defun = generate_let_defun(compiler, l, defun_name, bindings, match[2]);
  var let_args = generate_let_args(l, bindings);
  var pass_env = {
    TAG: /* Call */3,
    _0: [
      l,
...
function generate_let_defun(compiler, l, name, bindings, body) {
  var any = compiler.env;
  var args;
  args = any.TAG === /* Cons */1 ? any._0[2] : ({
        TAG: /* Nil */0,
        _0: Sexp.location_of(any)
      });
  var new_arguments = List.map((function (param) {
          var match = param._0;
          return {
                  TAG: /* Atom */4,
                  _0: [
  ...
  var inner_function_args = {
    TAG: /* Cons */1,
    _0: [
      l,
      args,
      Comptypes.list_to_cons(l, Sexp.location_of)(new_arguments)
    ]
  };
  return {
          TAG: /* Defun */2,
...
function dummy_functions(compiler) {
  return List.fold_left((function (c, param) {
                switch (param.TAG | 0) {
                  case /* Defconstant */0 :
                  case /* Defmacro */1 :
                      return c;
                  case /* Defun */2 :
                      return {
                              ...
                              macros: c.macros,
                              defuns: c.defuns,
                              parentfns: Curry._2(Comptypes.StringSet.add, param._0[1], c.parentfns),
                              env: c.env,
                              to_process: c.to_process,
                              final_expr: c.final_expr,
                              final_code: c.final_code
                            };
                  
                }
              }), compiler, compiler.to_process);
}
...
function start_codegen(opts, param) {
  ...
  var match$1 = hoist_body_let_binding(use_compiler, match[3]);
  var let_helpers_with_expr = process_helper_let_bindings(use_compiler, List.concat({
            hd: match$1[0],
            tl: {
              hd: match[2],
              tl: /* [] */0
  ...
  var live_helpers = List.filter(is_defun)(let_helpers_with_expr);
...
function codegen(opts, cmod) {
  var compiler = dummy_functions(start_codegen(opts, cmod));
  console.log(Sexp.to_string(codegen_to_sexp(opts, compiler)));
  return Comptypes.compBind((function (c) {
                return Comptypes.compBind((function (final_env) {
                              ...
                              var l = match._0;
                              if (opts.inDefun) {
                                console.log("defun env " + (Sexp.to_string(c.env) + (" code " + Sexp.to_string(code))));
...
exports.generate_let_defun = generate_let_defun;
exports.generate_let_args = generate_let_args;
exports.hoist_body_let_binding = hoist_body_let_binding;
exports.process_helper_let_bindings = process_helper_let_bindings;
...
exports.dummy_functions = dummy_functions;
